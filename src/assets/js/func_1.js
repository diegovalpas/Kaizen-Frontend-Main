...
jQuery(function($) {
    ...
    //Cambiar index.html por ruta que enviará los datos del postulante/reclutador
...
$("form#wrapped")
    .validate({
        rules: {
            fileupload: {
                fileType: {
                    types: ["pdf", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "image/png" , "image/jpeg"]
                },
                maxFileSize: {
                    "unit": "KB",
                    "size": 3000
