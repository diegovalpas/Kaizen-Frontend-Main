...
@Component({
  selector: 'app-postempleo',
  templateUrl: './postempleo.component.html',
  styleUrls: []
})
export class PostempleoComponent implements OnInit {
  ...
  Publicarempleo(): void {
    ...
    this.reclutadorservice.Publicarempleo(puestowork,this.currentUser.idReclutador).subscribe(
      data => {
        console.log(data);
    });
  }
